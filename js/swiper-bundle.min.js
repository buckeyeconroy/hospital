      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          const s = this,
            { params: a } = s;
          a.cssMode ||
            (a.autoHeight && s.updateAutoHeight(), D({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
        },
    ...
    mount(e) {
      ...
      return (
        ...
        Object.assign(t, {
          ...
          rtlTranslate:
            "horizontal" === t.params.direction && ("rtl" === s.dir.toLowerCase() || "rtl" === w(s, "direction")),
                ...
                t.pagination.bullets.forEach((s) => {
                  t.params.pagination.clickable &&
                    ...
                    t.params.pagination.renderBullet ||
                      (d(s, "button"), p(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, b(s) + 1)))),
